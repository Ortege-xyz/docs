...
| User                               | Studio                                      | Lakehouse                                      | OrtegeGPT |
|------------------------------------|---------------------------------------------|------------------------------------------------|-----------|
| **Blockchain Enthusiasts**         | Dashboards, SQL Lab                         | API, All Datasets                              | Yes       |
| **Crypto Investors**               | Dashboards, SQL Lab                         | Pricing, DEX Datasets                          | Yes       |
| **Data Analysts**                  | SQL Lab                                     | All Datasets                                   | Yes       |
| **Companies Seeking Integrations** | SQL Lab                                     | API                                            | Yes       |
